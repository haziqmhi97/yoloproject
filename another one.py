    ...
    if (cap.isOpened() == False):  # check if videocapture not opened
        ...
        while (cap.isOpened):  # loop until cap opened or video not complete
            ...
            if ret:  # if success is true, means frame exist
                ...
                cv2.imwrite(fr'D:\AI Prolects and Libs\Codes\yolov7-pose-estimation-main\yolov7-pose-estimation-main\New folder\Frame[{frame_count}].jpg', im0)  # 111
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='output_video.mp4', help='video/0 for webcam')  # video source
